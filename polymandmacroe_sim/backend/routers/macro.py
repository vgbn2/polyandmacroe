...
# Import Models from External Module (assuming sys.path is set correctly in main.py)
try:
    from macroe.database import Country, CompositeScore, Observation, Indicator
except ImportError:
    # Fallback/Mock for development if path is broken
    print("WARNING: Could not import macroe.database. Ensure sys.path is correct.")
    class Country: pass
    class CompositeScore: pass
